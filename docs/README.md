...
| [ADMIN_DASHBOARD_TESTING.md](ADMIN_DASHBOARD_TESTING.md) | Admin dashboard test checklist |
...
| [FACE_RECOGNITION_SETUP.md](FACE_RECOGNITION_SETUP.md) | Face recognition (dlib) setup |
